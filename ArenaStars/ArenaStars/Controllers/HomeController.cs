    ...
    public class HomeController : Controller
    {
        public ActionResult Index()
        {
            ...
            using (ArenaStarsContext context = new ArenaStarsContext())
            {
                ...
                foreach (Models.Tournament tournament in getTournaments.Take(5))
                {
                    tournaments.Add(
                        new ViewTournament()
                        {
        ...
        public ActionResult DummyData()
        {
            using (ArenaStarsContext context = new ArenaStarsContext())
            {
                List<Models.User> Tournament1UserList = new List<Models.User>(); //Userlist for tournament 1
        ...
        public ActionResult MatchMakeSearch(int timeSearched)
        {
            ...
            object myObject;
            List<string> errorMessages = new List<string>();
            Models.User you = new Models.User();
            Models.User opponent = new Models.User();
                ...
                using (ArenaStarsContext context = new ArenaStarsContext())
                {
                    ...
                    if (possibleOpponents.Count() > 0)
                    {
                        ...
                        if (errorMessages.Count == 0)
                        {
                            ...
                            {
                                Participants = new List<Models.User>()
                                {
                                    you,
                                    opponent
                                },
        ...
        public ActionResult CheckIfFoundGame()
        {
            ...
            if ((bool)Session["isLoggedIn"])
            {
                ...
                using (ArenaStarsContext context = new ArenaStarsContext())
                {
                    ...
                    Models.User you = getYouUser.FirstOrDefault();
